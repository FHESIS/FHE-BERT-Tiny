#!/usr/bin/env python3
"""
Benchmarks plaintext vs. encrypted (FHE) BERT-tiny sentiment inference on a
fixed set of 5 negative and 5 positive sentences, recording output logits and
wall-clock inference time for each backend.
